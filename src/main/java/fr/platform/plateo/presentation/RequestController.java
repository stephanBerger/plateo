...
public class RequestController {
    ...
    public String postEstimateSave( @PathVariable Integer processInstanceId, @PathVariable Integer estimateid,
         ...
         * this.estimateHasServService.findServiceId(processInstanceId)
         * .orElseThrow(() -> new
         * IllegalArgumentException("L' Id est invalide")); if (ehs != null) {
         * this.LOGGER.info("Une instance de ce devis est deja en cours");
