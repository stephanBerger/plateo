...
public class RequestController {
	...
	public String estimateRequestNext(@PathVariable Integer estimateid, Model model,
			HttpServletRequest req,
			@ModelAttribute("assigneeId") Integer assigneeId, Principal principal) {
		this.LOGGER.info(
				"Le client continue avec une autre prestation avec Estimate ID : " + estimateid);
	...
	public String serviceRequest(@PathVariable Integer professionId,
			...
			@PathVariable Integer estimateid, Model model,
			@ModelAttribute("assigneeId") Integer assigneeId,
			Principal principal) {
	...
	public String serviceProcess(Model model, @PathVariable String processInstanceId,
	...
	public String serviceTask(@PathVariable String processInstanceId,
			...
			@PathVariable Integer serviceId, @ModelAttribute("assigneeId") Integer assigneeId,
			Model model,
			Principal principal, Estimate estimate) {
		Task task = this.bpmService.getTaskByProcessInstanceIdAndAssigneeId(assigneeId,
				processInstanceId);
		if (task != null) {
			Client client = this.clientService.loadUserByUsername(principal.getName());
			model.addAttribute("client", client);
	...
	public String postEstimateSave(@Valid Estimate estimate, BindingResult result, Model model,
			Client client,
			@PathVariable String processInstanceId, @PathVariable Integer estimateid,
			@PathVariable Integer serviceId,
			@ModelAttribute("assigneeId") Integer assigneeId, Principal principal,
			@RequestParam(value = "prestation") String prestation,
