...
public class FacebookService  {
	...
	public com.restfb.types.User getUserInfo(final String accessToken) {
		...
		return facebookClient.fetchObject("me", com.restfb.types.User.class, Parameter.with("fields", fields));
	}
	...
	public UserDetails buildUser(com.restfb.types.User user) {
		...
		UserDetails userDetail = new User(user.getEmail(), "", enabled, accountNonExpired, credentialsNonExpired,
