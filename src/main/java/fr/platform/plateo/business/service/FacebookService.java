...
public class FacebookService {
	...
	public String getToken(final String code) throws ClientProtocolException, IOException {
		String link = String.format(this.env.getProperty("facebook.link.get.token"),
				this.env.getProperty("facebook.app.id"),
				this.env.getProperty("facebook.app.secret"),
				this.env.getProperty("facebook.redirect.uri"), code);
