...
(function(f) {
    ...
    q.defaults = {
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(filtré depuis _MAX_ total entrées)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Affichage _MENU_ entrées",
            sLoadingRecords: "Chargement...",
            sProcessing: "Execution...",
            sSearch: "Recherche:",
            sSearchPlaceholder: "",
            sUrl: "",
...
*/
(function(f) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(c) { return f(c, window, document) }) : "object" === typeof exports ? module.exports = function(c, e) {
        c || (c = window);
    ...
    f.extend(c.ext.buttons, {
        ...
        colvisRestore: {
            ...
            init: function(a, b, d) { d._visOriginal = a.columns().indexes().map(function(b) { return a.column(b).visible() }).toArray() },
...
*/
(function(d) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(t) { return d(t, window, document) }) : "object" === typeof exports ? module.exports = function(t, r) {
        t || (t = window);
    ...
    d.extend(k.prototype, {
        ...
        fnOrder: function(a, b) {
            ...
            if (a === w) { b = 0; for (g = h.length; b < g; b++) c.push(h[b]._ColReorder_iOrigCol); return c }
            if (b) {
                h = this.fnOrder();
                b = 0;
        ...
        _fnMouseMove: function(a) {
            ...
            for (var d = function(a) { for (; 0 <= a;) { a--; if (0 >= a) return null; if (b.s.aoTargets[a + 1].x !== b.s.aoTargets[a].x) return b.s.aoTargets[a] } }, h = function() {
                ...
                if (this._fnIsLtr()) { if (a < q) { var l = n; break } } else if (a > q) { l = n; break }
            }
    ...
    c.extend(p.prototype, {
        ...
        _fnClone: function(a, b, d, h) {
            ...
            if (h) {
                ...
                n = 0;
                for (m = g.length; n < m; n++) { var t = 0; for (l = g[n].length; t < l; t++) p[n][t].cell.className = g[n][t].cell.className, c("span.DataTables_sort_icon", p[n][t].cell).each(function() { this.className = c("span.DataTables_sort_icon", g[n][t].cell)[0].className }) }
            }
    ...
    a.extend(m.prototype, {
        ...
        _mouseUp: function(c) {
            ...
            this.c.editor ? (this.c.enable = !1, this.c.editor.edit(p, !1, a.extend({ submit: "changed" }, this.c.formOptions)).multiSet(g, m).one("preSubmitCancelled.rowReorder", function() {
                ...
                function() { b.draw(!1) }).one("submitSuccess.rowReorder", function() { x() }).one("submitComplete", function() {
                e.c.enable = !0;
                e.c.editor.off(".rowReorder")
            }).submit()) : x()
        },
